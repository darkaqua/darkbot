module.exports = (oldMember, newMember) => {
    ...
    //Si el miembro está stremeando
      ...
      newMember.addRole(newMember.guild.roles.find("name", "[streaming]"))
      .catch(err =>
				console.log(`${err.message} (join [streaming])`)
			);
    //Si el miembro dejó de estremear
      ...
      newMember.removeRole(newMember.guild.roles.find("name", "[streaming]"))
      .catch(err =>
        console.log(`${err.message} (leave [streaming])`)
      );
    }
}
